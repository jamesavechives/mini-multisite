...
class WxPayApi
{
	 ...
	 */
        ...
        private static $mchid='0';
        private static $key='0';
        private static $site_id=0;
        public function __construct($appid=null,$mchid=null,$key=null,$site_id=null)
        {
            if($appid!=null){
              self::$appid=$appid;
            }
	...
	{	
                $sslcert_path = APPPATH.'cert/'.self::$site_id.'/apiclient_cert.pem';
                $sslkey_path = APPPATH.'cert/'.self::$site_id.'/apiclient_key.pem';
		$ch = curl_init();
		//设置超时
